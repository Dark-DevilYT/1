...
bot_token = "6801946586:AAEyivnwNSGC7GBx_wF0y50tulpGiX8LunQ" #bot token from @BotFather
SmmPanelApi = "43e68ed3b4f59fd2a425192da419932f" # api key from eadysmmpanel.com you can change api link
bot = telebot.TeleBot(bot_token)
admin_user_id = 5860140864
welcome_bonus = 100
ref_bonus = 500
min_view = 100
max_view = 30000
required_channels = ['@devilsTools']  # more channel same as
payment_channel = "@devilsTools"
...
💳️ Pay with Paypal, Paytm, WebMoney, Perfect Money, Payeer ... 👉🏻 @s4rvesh0
...
"""
    ...
    button1 = InlineKeyboardButton("💲 PayPal", url="https://t.me/s4rvesh0")
